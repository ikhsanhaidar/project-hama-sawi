...
**PestGuard** adalah sistem deteksi hama otomatis berbasis *Deep Learning* yang menggunakan 4 model CNN berbeda untuk mendeteksi keberadaan hama pada tanaman sawi. Sistem ini dilengkapi dengan dashboard admin untuk monitoring performa model.
